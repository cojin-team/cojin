...
#if defined(NDEBUG)
# error "cojin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "cojin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // cojin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // cojin also requires low S in sigs
