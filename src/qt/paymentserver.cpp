...
const QString BITCOIN_IPC_PREFIX("cojin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/cojin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/cojin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/cojin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click cojin: links
...
//
// OSX-specific way of handling cojin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in cojin: URIs
