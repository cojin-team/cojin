...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/1NF1N18Y/cojin>";
    const std::string URL_WEBSITE = "<https://cojin.info";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Cojin devloper", 2022)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find cojin useful. "
